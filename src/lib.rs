#![warn(missing_docs)]
#![warn(unused_results)]
#![doc(html_root_url = "https://docs.rs/brownlit/1/")]

//! Macros for container literals with specific type.
//!
//! ```
//! #[macro_use] extern crate brownlit;
//!
//! # fn main() {
//! let map = hashmap!{
//!     "a" => 1,
...
//! ```
//!
//! The **brownlit** crate uses `=>` syntax to separate the key and value for the
...
/// Macro that converts the keys or key-value pairs passed to another brownlit
...
///
/// Here *macro_name* is any other brownlit macro and either or both of the
